...
async def _(event):
    ...
    packname = f"a631847622_by_noobanon_1"
    packshortname = f"a631847622_by_noobanon_1"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Jinga Stuxker"
        if userid == 631847622:
            packshortname = "JindaSticker"
        else:
            packshortname = f"JindaSticker" # format: Uni_Borg_userid
    ...
    await event.edit("`Kanging this stukur for moi pru master`!")
    ...
    await event.edit(f"`Sticker stolen now gub moni and take` [This](t.me/addstickers/{packshortname})")
