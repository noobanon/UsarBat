...
base by: @r4v4n4
created by: @A_Dark_Princ3 The Gey Boi
if you change these, you also gay.
"""
...
async def _(event):
    ...
    async with borg.conversation("@MemeAutobot") as bot_conv:
          ...
          if "Okay..." in response.text:
            await event.edit("```NUB?! This is not an image! This will take sum tym to convert to image owo 🧐```")
            thumb = None
            ...
            await event.delete()
            await borg.send_message(event.chat_id, "`Wait Nimbaa Lemme Finish This`")
